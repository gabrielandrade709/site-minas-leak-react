...
class FormContatoMobile extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            nome: '',
    ...
    render() {
        return (
            <>
                <div className="contato-conteudo-mobile">
                    <form className="formulario" autoComplete="off" onSubmit={this.handleSubmit}>
                        <div>
                            <TextField required fullWidth id="standard-required" label="Nome" name="nome" onChange={this.handleInputChange} />
                            <br />
                        </div>
                        <div>
                            <TextField required fullWidth id="standard-required" label="Sobrenome" name="sobrenome" onChange={this.handleInputChange} />
                            <br />
                        </div>
                        <div>
                            <InputMask
                            ...
                            >
                                {() => <TextField required fullWidth label="Celular" name="celular" />}
                            </InputMask>
                            <br />
                        </div>
                        <div>
                            <InputMask
                                ...
                                onChange={this.handleInputChange}
                            >
                                {() => <TextField fullWidth label="Telefone (não obrigatório)" name="telefone" />}
                            </InputMask>
                            <br />
                        </div>
                        <div>
                        ...
                        <div className="button-enviar-mobile">
...
export default FormContatoMobile;