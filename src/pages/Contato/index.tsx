        ...
        <>
            ...
            <div className="main-desktop">
                ...
                <div className="conteudo">
                    ...
                    <div className="focus-in-expand top-form-divider" data-aos="fade-up" data-aos-duration="2000">
                        <Divider />
                    </div>
                    <div className="form-contato focus-in-expand " data-aos="fade-up" data-aos-duration="2000">
            ...
            <div className="main-mobile">
                ...
                <div className="container">
                    ...
                    <div className="form-contato-mobile focus-in-expand " data-aos="fade-up" data-aos-duration="2000">
                        <div className="title-form">
                            <h3>Solicitar orçamento</h3>
                        </div>
                        <FormContatoMobile />
                    </div>
                    <div className="focus-in-expand divider-bottom-form" data-aos="fade-up" data-aos-duration="2000">
                        <Divider />
                    </div>
                    <div className="localizacao focus-in-expand" data-aos="fade-up" data-aos-duration="2000">
                        <h2>Nossa localização</h2>
